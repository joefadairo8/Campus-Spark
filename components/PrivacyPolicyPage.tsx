        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 p-8 bg-[var(--bg-secondary)] rounded-[2rem] border border-[var(--border-color)]">
            <p className="text-[var(--text-secondary)] text-sm leading-relaxed font-medium">
              ABC-Rally Limited ("ABC-Rally", "we", "our", or "us") operates the ABC-Rally collaboration marketplace platform. 
          ...
          <Section title="1. Information We Collect" defaultOpen>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li><strong className="text-[var(--text-primary)]">Profile Data:</strong> University, bio, social media handles, portfolio URLs, location, industry, and company size.</li>
              <li><strong className="text-[var(--text-primary)]">Transaction Data:</strong> Wallet top-ups, escrow activity, campaign allocations, gig payments, withdrawals, and bank account details for payouts.</li>
          ...
          <Section title="2. How We Use Your Information">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li>Send transactional emails (registration confirmations, payment receipts, proposal updates).</li>
          ...
          <Section title="3. Legal Basis for Processing">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              <li><strong className="text-[var(--text-primary)]">Contract:</strong> Processing necessary to provide the services you signed up for.</li>
              ...
              <li><strong className="text-[var(--text-primary)]">Legal Obligation:</strong> Where we are required to retain data to comply with law.</li>
            </ul>
          </Section>
          ...
          <Section title="4. Data Sharing and Third Parties">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li><strong className="text-[var(--text-primary)]">Other Users:</strong> Your public profile (name, bio, university, portfolio) is visible to other verified users on the platform for collaboration purposes.</li>
          ...
          <Section title="5. Data Retention">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li>Transaction records are retained for a minimum of 7 years for financial compliance.</li>
          ...
          <Section title="8. Security">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li>Role-based access control to restrict data access within the platform.</li>
