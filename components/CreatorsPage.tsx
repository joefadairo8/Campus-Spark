...
const CreatorsPage: React.FC<{ onNavigate: (page: string) => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-[var(--bg-primary)] min-h-screen font-sans text-[var(--text-primary)]">
      ...
      <section className="relative overflow-hidden pt-28 pb-24 border-b border-[var(--border-color)] text-center">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="inline-block px-4 py-1.5 mb-6 text-[10px] font-black tracking-[0.2em] text-spark-red uppercase bg-spark-red/5 border border-spark-red/10 rounded-full">
            For creators, digital professionals, media operators and activation talent.
          </div>
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-fancy font-black tracking-tighter leading-[1.1] mb-6 text-[var(--text-primary)]">
            Turn your skills, audience and execution capacity <span className="text-gradient-red italic">into paid opportunities.</span>
          </h1>
          <p className="text-base md:text-lg text-[var(--text-secondary)] mb-10 leading-relaxed max-w-3xl mx-auto font-medium">
            Create content, manage campaigns, promote to communities or deliver activations for brands and associations.
          </p>
      ...
      {/* ── Capabilities (Create, Manage, Distribute, Activate) ── */}
      <section className="py-16 bg-[var(--bg-secondary)] border-b border-[var(--border-color)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {/* CREATE */}
            <div className="bg-[var(--bg-primary)] p-6 rounded-[2rem] border border-[var(--border-color)] flex flex-col justify-between hover:border-spark-red/30 transition-all duration-300 shadow-sm">
              <div>
                <div className="w-10 h-10 bg-spark-red/10 rounded-xl flex items-center justify-center text-spark-red font-black mb-4">
                  <Sparkles className="w-5 h-5" />
                </div>
                <h3 className="text-sm font-black text-[var(--text-primary)] uppercase tracking-wider mb-2">CREATE</h3>
                <p className="text-xs text-[var(--text-secondary)] font-medium leading-relaxed">
                  Produce content, design, photography, video or other campaign materials.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[var(--bg-primary)] p-6 rounded-[2rem] border border-[var(--border-color)] flex flex-col justify-between hover:border-spark-red/30 transition-all duration-300 shadow-sm">
              <div>
                ...
                <h3 className="text-sm font-black text-[var(--text-primary)] uppercase tracking-wider mb-2">MANAGE</h3>
                <p className="text-xs text-[var(--text-secondary)] font-medium leading-relaxed">
                  Manage social media, communities, email, publicity or campaigns.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[var(--bg-primary)] p-6 rounded-[2rem] border border-[var(--border-color)] flex flex-col justify-between hover:border-spark-red/30 transition-all duration-300 shadow-sm">
              <div>
                ...
                <h3 className="text-sm font-black text-[var(--text-primary)] uppercase tracking-wider mb-2">DISTRIBUTE</h3>
                <p className="text-xs text-[var(--text-secondary)] font-medium leading-relaxed">
                  Promote campaigns through WhatsApp, campus media or owned communities.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[var(--bg-primary)] p-6 rounded-[2rem] border border-[var(--border-color)] flex flex-col justify-between hover:border-spark-red/30 transition-all duration-300 shadow-sm">
              <div>
                ...
                <h3 className="text-sm font-black text-[var(--text-primary)] uppercase tracking-wider mb-2">ACTIVATE</h3>
                <p className="text-xs text-[var(--text-secondary)] font-medium leading-relaxed">
                  Support events, mobilise communities and execute physical campaigns.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-base text-[var(--text-secondary)] font-medium">
              Whether your strength is creating content, managing communities, distributing media, or executing events, ABC-Rally has a path for you.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6 text-left">
            {/* Community & Media Operator Card */}
            <div className="bg-[var(--bg-secondary)] rounded-[2rem] overflow-hidden border border-[var(--border-color)] group card-hover shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-spark-red/5">
              <div className="h-2 bg-spark-red"></div>
              <div className="p-8 flex flex-col h-full justify-between">
                <div>
                  <h3 className="text-lg font-bold text-[var(--text-primary)] mb-3 group-hover:text-spark-red transition-colors">Community &amp; Media Operator</h3>
                  <p className="text-[var(--text-secondary)] text-sm mb-6 font-medium leading-relaxed">
                    Leverage your WhatsApp status, campus channels, or online communities to distribute brand campaigns.
                  </p>
                  <ul className="space-y-3 mb-10 text-[var(--text-secondary)] font-semibold text-xs">
                    <li className="flex items-center"><span className="w-1.5 h-1.5 bg-spark-red rounded-full mr-3"></span>WhatsApp &amp; Telegram broadcast distribution</li>
                    <li className="flex items-center"><span className="w-1.5 h-1.5 bg-spark-red rounded-full mr-3"></span>Community &amp; forum moderation</li>
                    <li className="flex items-center"><span className="w-1.5 h-1.5 bg-spark-red rounded-full mr-3"></span>Campus media channel promotions</li>
                  </ul>
                </div>
                <button
                  onClick={handleStart}
            ...
            {/* Content & Digital Specialist Card */}
            <div className="bg-[var(--bg-secondary)] rounded-[2rem] overflow-hidden border border-[var(--border-color)] group card-hover shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-spark-red/5">
              <div className="h-2 bg-[var(--text-primary)] opacity-20"></div>
              <div className="p-8 flex flex-col h-full justify-between">
                <div>
                  <h3 className="text-lg font-bold text-[var(--text-primary)] mb-3 group-hover:text-spark-red transition-colors">Content &amp; Digital Specialist</h3>
                  <p className="text-[var(--text-secondary)] text-sm mb-6 font-medium leading-relaxed">
                    Monetize your creative assets, writing, social media management, or design skills with paid brand campaigns.
                  </p>
                  <ul className="space-y-3 mb-10 text-[var(--text-secondary)] font-semibold text-xs">
                    <li className="flex items-center"><span className="w-1.5 h-1.5 bg-spark-red rounded-full mr-3"></span>Produce video, graphics &amp; copy</li>
                    <li className="flex items-center"><span className="w-1.5 h-1.5 bg-spark-red rounded-full mr-3"></span>Manage social handles &amp; email newsletters</li>
                    <li className="flex items-center"><span className="w-1.5 h-1.5 bg-spark-red rounded-full mr-3"></span>Run launch campaigns &amp; publicity</li>
                  </ul>
                </div>
                <button
                  onClick={handleStart}
            ...
            {/* Event & Activation Talent Card */}
            <div className="bg-[var(--bg-secondary)] rounded-[2rem] overflow-hidden border border-[var(--border-color)] group card-hover shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-spark-red/5">
              <div className="h-2 bg-[var(--text-secondary)] opacity-10"></div>
              <div className="p-8 flex flex-col h-full justify-between">
                <div>
                  <h3 className="text-lg font-bold text-[var(--text-primary)] mb-3 group-hover:text-spark-red transition-colors">Event &amp; Activation Talent</h3>
                  <p className="text-[var(--text-secondary)] text-sm mb-6 font-medium leading-relaxed">
                    Provide real, hands-on execution value at physical events, campus activations, and promotional projects.
                  </p>
                  <ul className="space-y-3 mb-10 text-[var(--text-secondary)] font-semibold text-xs">
      ...
      <section className="py-20 bg-[var(--bg-secondary)] border-b border-[var(--border-color)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-2xl md:text-4xl font-fancy font-black text-[var(--text-primary)] mb-6">
            Built for Nigeria's <span className="text-gradient-red italic">Creative &amp; Digital Talent</span>
          </h2>
          <p className="text-base text-[var(--text-secondary)] font-medium max-w-2xl mx-auto mb-12 leading-relaxed">
            ABC-Rally connects creators, digital managers, media operators and activation talent with brands and associations that need their execution capacity.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              { label: 'Community Managers', icon: <Users className="w-5 h-5" /> },
              { label: 'WhatsApp & Media Operators', icon: <MessageSquare className="w-5 h-5" /> },
              { label: 'Marketers & Writers', icon: <Compass className="w-5 h-5" /> },
              { label: 'Photographers & Videographers', icon: <Camera className="w-5 h-5" /> },
              ...
              <div key={i} className="flex flex-col items-center justify-center p-6 bg-[var(--bg-primary)] border border-[var(--border-color)] rounded-2xl hover:border-spark-red/30 transition-all duration-300">
                <div className="text-spark-red mb-3 bg-spark-red/10 p-2.5 rounded-xl">{role.icon}</div>
                <span className="text-xs font-bold text-[var(--text-primary)] text-center">{role.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[var(--bg-primary)] border-b border-[var(--border-color)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {[
              { icon: <Compass className="w-6 h-6" />, title: 'Discover Gigs', desc: 'Find open roles tailored to your exact skills, media channels, and campus location.' },
              ...
              <div key={i} className="bg-[var(--bg-secondary)] p-6 rounded-[2rem] border border-[var(--border-color)] group card-hover transition-all duration-300">
      ...
      <section className="py-20 bg-[var(--bg-secondary)] border-b border-[var(--border-color)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
            {[
              { step: '01', title: 'Create Profile', desc: 'Set up your professional creator portfolio, showcase past work, and define your capabilities.' },
              { step: '02', title: 'Upload Portfolio', desc: 'Connect your channels, upload media/proof of work, and define your creative skills and services.' },
              { step: '03', title: 'Browse & Apply', desc: 'Search and apply for active campaigns, event sponsorships, and specific execution roles.' },
              ...
              <div key={i} className="p-8 bg-[var(--bg-primary)] rounded-[2rem] border border-[var(--border-color)] flex flex-col gap-4 relative overflow-hidden group hover:border-spark-red/30 transition-all duration-300">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-5 text-left">
            {[
              ...
              <div key={i} className="p-6 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-[2rem] flex flex-col gap-4">
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          <div className="p-12 bg-spark-black rounded-[3rem] text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-fancy font-black mb-4">Ready to Monetize Your Skills &amp; Execution?</h2>
              <p className="text-gray-400 font-medium mb-10 max-w-xl mx-auto text-sm">
                Set up your creator profile, link your portfolios, and unlock access to paid gigs, campaign management roles, and sponsored campaigns across Nigeria.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={handleStart}
